  ...
  return (
    <>
      <main className='h-auto bg-[linear-gradient(to_bottom,#050b13,#11131e,#1c1727,#2b192e,#3c1b30,#431a2f,#4a192c,#511929,#511627,#501324,#501022,#4f0c1f)]'>
        ...
        <div className="about_description text-center bg-[rgba(0,0,0,0.4)] h-80 w-[650px] ml-[100px] mt-[100px] border-[rgba(88,221,229,255)] border-[3px]">
        ...
        <div className="profile_about_Box  bg-[rgba(6,11,19,0.8)] h-[450px] w-[600px] m-[50px] border-solid border-4 border-[rgba(88,221,229,255)] hover:bg-[rgba(106,39,43,255)">
          <div>
        ...
        <div className="profileBox_right_side text-center bg-[rgba(6,11,19,255)] h-[450px] w-[600px] float-right m-[50px] border-[3px] border-[rgba(88,221,229,255)]">
          <div>
