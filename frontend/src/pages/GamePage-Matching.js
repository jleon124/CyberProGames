...
const GamePageMatching = () => {
  ...
  const getGameData = async () => {
    const response = await fetch('http://localhost:3500/game/64485825d440c37883379430', {
      method: 'GET'
    })
  ...
  const setGameComments = async () => {
    const response = await fetch(`http://localhost:3500/comment/64485825d440c37883379430/comments`, {
      method: 'GET',
    })
