...
const GamePageMatching = () => {
  ...
  const getGameData = async () => {
    const response = await fetch('https://cyber-pro-games-backend.vercel.app/game/64485825d440c37883379430', {
      method: 'GET'
    })
  ...
  const setGameComments = async () => {
    const response = await fetch(`https://cyber-pro-games-backend.vercel.app/comment/64485825d440c37883379430/comments`, {
      method: 'GET',
    })
