...
const GamePageRocket = () => {
  ...
  const getGameData = async () => {
    const response = await fetch('https://cyber-pro-games-backend.vercel.app/game/6448594dd440c37883379431', {
      method: 'GET'
    })
  ...
  const setGameComments = async () => {
    const response = await fetch(`https://cyber-pro-games-backend.vercel.app/comment/6448594dd440c37883379431/comments`, {
      method: 'GET',
    })
