...
const GamePageBulletBlitz = () => {
  ...
  const getGameData = async () => {
    const response = await fetch('https://cyber-pro-games-backend.vercel.app/game/64485b00d440c37883379432', {
      method: 'GET'
    })
  ...
  const setGameComments = async () => {
    const response = await fetch(`https://cyber-pro-games-backend.vercel.app/comment/64485b00d440c37883379432/comments`, {
      method: 'GET',
    })
  ...
  return (
    <main className='h-[1750px] pt-5 pb-5'>
      ...
      <GamePageBox
        name={"Bullet Blitz"}
        src={'games/bulletblitz/index.html'} />
      <br></br>
      <div className='flex'>
        <div className='flex '>
